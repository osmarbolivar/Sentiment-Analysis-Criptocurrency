...
phi_pi = 1.5;      // Taylor rule inflation coefficient (Taylor principle >1)&#8203;
phi_y  = 0.25;     // Taylor rule output coefficient (small)&#8203;
...
// (Assume datafile 'bolivia_data.csv' contains columns: [pi_obs, y_obs, e_obs, s_obs] from Jan-2024 to Mar-2025)
