...
M_.dynamic_g1_sparse_rowval = int32([3 2 4 5 6 1 2 3 2 3 1 3 2 4 1 4 5 4 6 1 1 2 5 6 2 3 ]);
M_.dynamic_g1_sparse_colval = int32([3 4 4 5 6 7 7 7 8 8 9 9 10 10 11 11 11 12 12 13 14 14 19 20 21 22 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 2 4 5 6 9 11 13 15 18 20 21 23 23 23 23 23 24 25 26 27 ]);
...
save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'dsge_1_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
